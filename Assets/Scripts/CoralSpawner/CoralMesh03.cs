...
public class CoralMesh03 : MonoBehaviour
...

{
    ...
    [Range(0, 180)] public int angle1 = 45;
    [Range(0, 180)] public int angle2 = 45;
    [Range(0, 180)] public int angle3 = 45;
...
/// </summary>
[CustomEditor(typeof(CoralMesh03))]
public class CoralMesh03Editor : Editor
{
    ...
    override public void OnInspectorGUI()
    {
        ...
        {
            CoralMesh03 c = (target as CoralMesh03);
            c.Build();
        }
